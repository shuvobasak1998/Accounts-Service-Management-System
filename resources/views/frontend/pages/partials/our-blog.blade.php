        ...
        <div class="row">
            <div class="col-lg-4 col-md-6 col-sm-12">
                <div class="blog-post-thumb">
                    <div class="img">
                        <img src="{{ asset('frontend/images/blog-item-01.png') }}" alt="">
                    </div>
                    <div class="blog-content">
                        ...
                        <a href="{{ route('singleBlog',['slug' => 'your-static-slug']) }}" class="button-custom-style">
            ...
            <div class="col-lg-4 col-md-6 col-sm-12">
                <div class="blog-post-thumb">
                    <div class="img">
                        <img src="{{ asset('frontend/images/blog-item-02.png') }}" alt="">
                    </div>
                    <div class="blog-content">
                        <h3>
            ...
            <div class="col-lg-4 col-md-6 col-sm-12">
                <div class="blog-post-thumb">
                    <div class="img">
                        <img src="{{ asset('frontend/images/blog-item-03.png') }}" alt="">
                    </div>
                    <div class="blog-content">
                        <h3>
