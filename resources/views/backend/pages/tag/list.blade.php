...
@section('content')
  <div class="d-flex justify-content-between align-items-center mb-2">
    ...
    <a href="{{ route('tag.create') }}" class="btn btn-success">Create New</a>
  </div>
                  ...
                  <tr>
                    ...
                    <td class="fixed-right">
                      <div class="d-flex gap-3 align-items-center">
                        <a href="{{ route('tag.edit', $ServiceCatrgoryinfo->id) }}" class="btn btn-outline-info"><i
                            class="fas fa-pencil-alt"></i></a>
                        <a href="{{ route('tag.delete', $ServiceCatrgoryinfo->id) }}" class="btn btn-outline-danger ml-1"
