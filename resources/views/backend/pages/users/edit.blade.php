      ...
      <div class="col-lg-12">
        <div class="card">
          <div class="card-body">
            ...
            @endif
            <form method="POST" class="needs-validation" action="{{ route('user.update', $edit_data->id) }}" enctype = "multipart/form-data">
              @csrf
              @if (isset($edit_data))
                @method('PUT')
              @endif
                    ...
                    <div class="card mb-4 mb-xl-0">
                      ...
                      <div class="card-body text-center">
                        ...
                        <img id="previewImage" class="img-account-profile rounded-circle mb-2"
                          src="{{ asset('storage/' . $edit_data->profile_photo_path) }}" alt="Profile Picture" width="150" height="150">
                          ...
                          <div class="col-md-6">
                            ...
                            <select class="form-control" name="user_role_id" id="exampleFormControlSelect12">
                              ...
                              @foreach ($user_role as $id => $role)
                                <option value="{{ $id }}"
                                  {{ old('user_role_id', $edit_data->user_role_id ?? '') == $id ? 'selected' : '' }}>{{ $role }}</option>
                              @endforeach
                            </select>
                          </div>
                        </div>
