...
@section('css')
  ...
  <link href="{{ asset('backend/theme/plugins/DataTables/DataTables-1.10.18/css/jquery.dataTables.min.css') }}" rel="stylesheet" />
  <link href="{{ asset('backend/theme/plugins/jvectormap/jquery-jvectormap-2.0.3.css') }}" rel="stylesheet" />
  <link href="{{ asset('backend/theme/plugins/daterangepicker/daterangepicker.css') }}" rel="stylesheet" />
  <link href="https://cdn.quilljs.com/1.3.6/quill.snow.css" rel="stylesheet">
  <link href="{{ asset('backend/theme/plugins/toaster/toastr.min.css') }}" rel="stylesheet" />
@endsection
@section('css-bottom')
  <link href="{{ URL::asset('/assets/css/dashboard.min.css') }}" rel="stylesheet" type="text/css" />
@endsection
@section('content')
  @component('backend.common-components.breadcrumb')
    @slot('pagetitle')
      @lang('translation.kda')
    @endslot
    @slot('title')
      @lang('translation.Dashboard')
    @endslot
    ...
    <div class="col-xl-3 col-sm-6">
      <div class="card card-default card-mini">
        <div class="card-header">
          <h2>$18,699</h2>
          <div class="dropdown">
            <a class="dropdown-toggle icon-burger-mini" href="#" role="button" id="dropdownMenuLink" data-toggle="dropdown" aria-haspopup="true"
              aria-expanded="false">
            </a>
      ...
      <div class="card card-default chat">
        <div class="card-header">
          ...
          <div class="dropdown dropdown-chat-state">
            <button class="dropdown-toggle btn btn-primary btn-rounded-circle" type="button" id="dropdownMenuButton" data-toggle="dropdown"
              aria-haspopup="true" aria-expanded="false" data-display="static">
...
@endsection
@section('script')
  <script src="{{ asset('backend/theme/plugins/apexcharts/apexcharts.js') }}"></script>
  <script src="{{ asset('backend/theme/plugins/DataTables/DataTables-1.10.18/js/jquery.dataTables.min.js') }}"></script>
  <script src="{{ asset('backend/theme/plugins/jvectormap/jquery-jvectormap-2.0.3.min.js') }}"></script>
  <script src="{{ asset('backend/theme/plugins/jvectormap/jquery-jvectormap-world-mill.js') }}"></script>
  <script src="{{ asset('backend/theme/plugins/jvectormap/jquery-jvectormap-us-aea.js') }}"></script>
  <script src="{{ asset('backend/theme/plugins/daterangepicker/moment.min.js') }}"></script>
  <script src="{{ asset('backend/theme/plugins/daterangepicker/daterangepicker.js') }}"></script>
  ...
  <script src="{{ asset('backend/theme/plugins/toaster/toastr.min.js') }}"></script>
  <script src="{{ asset('backend/theme/js/mono.js') }}"></script>
  <script src="{{ asset('backend/theme/js/chart.js') }}"></script>
  <script src="{{ asset('backend/theme/js/map.js') }}"></script>
  <script src="{{ asset('backend/theme/js/custom.js') }}"></script>
@endsection
