...
{{-- @dd(auth()->id()) --}}
      ...
      <div class="search-form">
        ...
        <ul class="dropdown-menu dropdown-menu-search">
          <li class="nav-item">
            <a class="nav-link" href="index.html">Find Something</a>
          </li>
        </ul>
      ...
      <ul class="nav navbar-nav">
        ...
        <li class="dropdown user-menu">
          <button class="dropdown-toggle nav-link" data-toggle="dropdown">
            <img src="{{ asset('storage/' . auth()->user()->profile_photo_path) }}" class="user-image rounded-circle" alt="User Image" />
          ...
          <ul class="dropdown-menu dropdown-menu-right">
            ...
            <li>
              <a class="dropdown-link-item" href="{{ route('user.edit', Auth::user()->id) }}">
