...
(function ($) {
  ...
  function initSelect2() {
    $(".Select2Search").each(function () {
      ...
      placheholder = placheholder !== undefined ? placheholder : "Type | Search | Select";
      //alert(placheholder);
      S2Element.select2({
    ...
    $(document).on("change", ".Select2Search", function () {
      ...
      if (elm) {
        ...
        $.each(result, function (key, elem) {
          $("#" + elem).attr("data-parent", val).val([]).trigger("change");
        });
      }
    });
  }
  function tinymceText() {
    tinymce.init({
      ...
      plugins: ["advlist image lists charmap print preview hr anchor pagebreak", "searchreplace wordcount visualblocks visualchars code fullscreen insertdatetime media nonbreaking", "table emoticons template paste help"],
      toolbar: "insertfile undo redo | styleselect | bold italic | alignleft aligncenter alignright alignjustify | bullist numlist outdent indent | image | print preview media | forecolor backcolor emoticons",
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkCA_ACCOUNT"] = self["webpackChunkCA_ACCOUNT"] || [];
...
/******/ 	__webpack_require__.O(undefined, ["backend/css/app"], () => (__webpack_require__("./resources/js/app.js")))
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["backend/css/app"], () => (__webpack_require__("./resources/scss/app.scss")))
